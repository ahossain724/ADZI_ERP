...
@section('content')
    <section class="content-header"style="padding-top: 60px;">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('translate.iouadjustment') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">IOU Adjustment</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
     ...
     <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">{{ __('translate.iouadjustment') }}</h3>
        ...
        <!-- Card Header -->
        <div class="card-body">
            <form action="{{ route('storeiouadjustment') }}" method="POST" id="iouadjustment_form">
                @csrf
                <div class="row">
                    <div class="col">
                        <div class="row mt-2">
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                <label style="color: red">{{ __('translate.adjustmentfrom') }}</label>
                            </div>
                            <div class="col">
                                <select id="adjustment_from" name="adjustment_from" class="form-control border border-success select2bs4">
