...
class DeliveryOrderController extends Controller
{
    public function storedeliveryorder(Request $request)
    {
        $deliveryorderData = [
          ...
          'vat_challan'=> $request->vat_challan,
          'total_net_weight'=> $request->total_net_weight,
          'vehicle'=> $request->vehicle,
          'vat_challan_date'=> $request->vat_challan_date,
          'total_gross_weight'=> $request->total_gross_weight,
          'team'=> $request->team,
          'team_member'=> $request->team_member,
          'driver_responsible_person'=> $request->driver_responsible_person,
          'time'=> $request->time,
          'total_cartons'=> $request->total_cartons
        ];
        $save=DeliveryOrder::create($deliveryorderData);
        if ($save){
