...
use App\Models\YearEndProcessing;


class YearEndProcessingController extends Controller
{
    public function storeyearendprocessing(Request $request)
    {
        $yearendprocessingData = [
            'year'=> $request->year,
            'transfer_amount'=> $request->transfer_amount,
            'voucher_prefix'=> $request->voucher_prefix
        ];
        $save=yearendprocessing::create($yearendprocessingData);
        if ($save){
