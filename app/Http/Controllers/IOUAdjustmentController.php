...
use App\Models\IOUAdjustment;


class IOUAdjustmentController extends Controller
{
    public function storeiouadjustment(Request $request)
    {
        $iouadjustmentData = [
            'voucher_number'=> $request->voucher_number,
            'adjustment_from'=> $request->adjustment_from,
            'amount'=> $request->amount,
            'date'=> $request->date,
            'narration'=> $request->narration
        ];
        $save=IOUAdjustment::create($iouadjustmentData);
        if ($save){
