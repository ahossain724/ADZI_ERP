...
use App\Models\GLInterface;


class GLInterfaceController extends Controller
{
    public function storeglinterface(Request $request)
    {
        $glinterfaceData = [
            'glinterfacetype'=> $request->glinterfacetype,
            'itemgroup'=> $request->itemgroup,
            'customersupplieragent'=> $request->customersupplieragent,
            'warehouse'=> $request->warehouse,
            'account'=> $request->account
        ];
        $save=GLInterface::create($glinterfaceData);
        if ($save){
