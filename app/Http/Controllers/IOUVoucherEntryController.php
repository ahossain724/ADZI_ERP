...
use App\Models\IOUVoucherEntry;


class IOUVoucherEntryController extends Controller
{
    public function storeiouvoucher(Request $request)
    {
        $iouvoucherData = [
        ...
        $save=IOUVoucherEntry::create($iouvoucherData);
        if ($save){
