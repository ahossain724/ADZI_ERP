...
class UserDocController extends Controller
{
     public function storeuserdoc(Request $request)
    {
        $userdocData = [
            ...
            'referencefield' => $request->referencefield,
            'infogroups' => $request->infogroups,
            'printorgname' => $request->printorgname,
            'printorgaddress' => $request->printorgaddress,
            'printlogo' => $request->printlogo,
            'printcustomerdetails' => $request->printcustomerdetails,
            'printdeliverydetails' => $request->printdeliverydetails,
            'printstandardfooter' => $request->printstandardfooter,
            'active' => $request->active,
            'header' => $request->header,
            'footer' => $request->footer,
        ];
        $save=UserDoc::create($userdocData);
        if ($save){
