...
class CustomerController extends Controller
{
    public function storecustomer(Request $request)
    {
        $customerData = [
            ...
            'phone' => $request->phone,
            'url' => $request->url,
            'control_account_ar' => $request->control_account_ar,
            ...
            'date_of_financial_statement' => $request->date_of_financial_statement,
            'bin' => $request->bin,
            'points_ob' => $request->points_ob,
            ...
            'average_payment_days' => $request->average_payment_days,
            'credit_available' => $request->credit_available,
            'date_of_credit_application' => $request->date_of_credit_application,
            'date_incorporated' => $request->date_incorporated,
            'payment_instructions' => $request->payment_instructions,
            'remarks' => $request->remarks,
            'backorder_type' => $request->backorder_type,
            'name' => $request->name,
            'city' => $request->city,
