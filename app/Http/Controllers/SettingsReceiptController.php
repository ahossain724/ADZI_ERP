...
use App\Models\SettingsReceipt;


class SettingsReceiptController extends Controller
{
     public function storesettingsreceipt(Request $request)
    {
        $receiptData = [
        ...
        $save=SettingsReceipt::create($receiptData);
        if ($save){
