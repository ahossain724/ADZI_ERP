...
class VehicleController extends Controller
{
    public function storevehicle(Request $request)
    {
        $vehicleData = [
            ...
            'ctsize' => $request->ctsize,
            'notes' => $request->notes,
            'lulabelno' => $request->lulabelno,
            'owner' => $request->owner,
            'mlwkg' => $request->mlwkg,
            'uwkg' => $request->uwkg,
            'tonnage' => $request->tonnage,
            'budcapacity' => $request->budcapacity,
            ...
            'team' => $request->team,
            'documenttypedocumentnumber' => $request->documenttypedocumentnumber,
            'expirationdate' => $request->expirationdate,
        ];
        $save=Vehicle::create($vehicleData);
        if ($save){
