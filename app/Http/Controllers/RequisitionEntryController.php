...
{public function storerequisitionentry(Request $request)
    {
        $requisitionentryData = [
          ...
          'other_specifications'=> $request->other_specifications
          
        ];
        $save=RequisitionEntry::create($requisitionentryData);
        if ($save){
