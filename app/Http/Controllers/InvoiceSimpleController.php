...
use App\Models\InvoiceSimple;


class InvoiceSimpleController extends Controller
{
    public function storeinvoicesimple(Request $request)
    {
        $invoicesimpleData = [
            'voucher_number'=> $request->voucher_number,
            'control'=> $request->control,
            'sales'=> $request->sales,
            'customer_payer'=> $request->customer_payer,
        ...
        $save=InvoiceSimple::create($invoicesimpleData);
        if ($save){
